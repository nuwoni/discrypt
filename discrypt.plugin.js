...
// baseChina aka unibinary https://github.com/nst/UniBinary/ Nicolas Seriot, 2013-01-17  Toolsley, 2014-12-03 (JavaScript port) 
...
function DecryptData( Data, Key ){
	var Data;
	Data = unibinary.decodeString( Data );
	Data = btoa( Data );
...
function EncryptData( Data, Key ){ 
	...
	Data = atob( Data );
	Data = unibinary.encodeString( Data );	
	return Data;
}
...
discrypt.prototype.getAuthor = function () {
	return "nuwoni [aecfae8e377c495ef35e7a7b35fade16]";
};
